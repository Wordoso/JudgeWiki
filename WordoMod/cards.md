...
| ---- | ----- | -------------- | ------ | ---- | ---- | ----------- |
| Ashes | ![](small-card-images/Ashes.png) | ![]() | Special | Status | 1 | Exhaust. |
| Affliction | ![](small-card-images/Affliction.png) | ![]() | Curse | Curse | 2 | If this card is Exhausted, deal 10 damage to ALL enemies. Exhaust. |
| Foggy Mind | ![](small-card-images/FoggyMind.png) | ![]() | Curse | Curse | 1 | Shuffle 3 Dazed into your draw pile. Exhaust. |
| Infected | ![](small-card-images/Infected.png) | ![]() | Curse | Curse | 1 | Gain 2 Vulnerable. Exhaust. |
| Petrified | ![](small-card-images/Petrified.png) | ![]() | Curse | Curse | 1 | Countdown 3: Stun ALL enemies and exhaust this card. |
| Defend | ![](small-card-images/Defend.png) | ![](small-card-images/DefendPlus.png) | Basic | Skill | 1 | Gain 5(8) Block. |
| Ill Will | ![](small-card-images/IllWill.png) | ![](small-card-images/IllWillPlus.png) | Basic | Skill | 1 | Apply 1(2) Disease. |
| Strike | ![](small-card-images/Strike.png) | ![](small-card-images/StrikePlus.png) | Basic | Attack | 1 | Deal 6(9) damage. |
| Bad Memories | ![](small-card-images/BadMemories.png) | ![](small-card-images/BadMemoriesPlus.png) | Common | Skill | 1(0) | Cycle 2 cards.  |
| Boundless Greed | ![](small-card-images/BoundlessGreed.png) | ![](small-card-images/BoundlessGreedPlus.png) | Common | Skill | 0 | Draw a card for each Curse card in your hand. Exhaust. (not Exhaust.) |
| Break the Chains | ![](small-card-images/BreaktheChains.png) | ![](small-card-images/BreaktheChainsPlus.png) | Common | Skill | 0 | Exhaust 1(2) card(s). |
| Burden of Sin | ![](small-card-images/BurdenofSin.png) | ![](small-card-images/BurdenofSinPlus.png) | Common | Attack | 1 | Deal 8(12) damage. Next turn, Exhaust 1 card. |
| Cursed Buckler | ![](small-card-images/CursedBuckler.png) | ![](small-card-images/CursedBucklerPlus.png) | Common | Skill | 1 | Gain 5(8) Block. For each card in your Exhaust pile, gain an additional 1 Block. |
| Exorcism | ![](small-card-images/Exorcism.png) | ![](small-card-images/ExorcismPlus.png) | Common | Skill | 1 | Gain 4(7) Block. Apply 2 Vulnerable to ALL enemies. |
| Lantern Flame | ![](small-card-images/LanternFlame.png) | ![](small-card-images/LanternFlamePlus.png) | Common | Attack | 1 | Deal 8(11) damage. Exhaust a card in your hand. |
| Malice | ![](small-card-images/Malice.png) | ![](small-card-images/MalicePlus.png) | Common | Attack | 1 | Deal 10(14) damage. If there are no Curse cards in your hand, lose 2 HP. |
| Memento Mori | ![](small-card-images/MementoMori.png) | ![](small-card-images/MementoMoriPlus.png) | Common | Skill | 1 | Gain 7(10) Block. Shuffle a random Curse into your draw pile. |
| Repent | ![](small-card-images/Repent.png) | ![](small-card-images/RepentPlus.png) | Common | Skill | 1 | Draw 2(3) cards. Exhaust 1 card. |
| Resurrection | ![](small-card-images/Resurrection.png) | ![](small-card-images/ResurrectionPlus.png) | Common | Skill | 0 | Grave. Gain [E] [E] ([E]). Exhaust. |
| Retaliate | ![](small-card-images/Retaliate.png) | ![](small-card-images/RetaliatePlus.png) | Common | Attack | 1 | Deal 8(10) damage. Cycle 1 card.  |
| Sacrilege | ![](small-card-images/Sacrilege.png) | ![](small-card-images/SacrilegePlus.png) | Common | Skill | 0 | Gain 1(2) Potency. |
| Scatter Ashes | ![](small-card-images/ScatterAshes.png) | ![](small-card-images/ScatterAshesPlus.png) | Common | Attack | 1 | Deal 2(3) damage to a random enemy 4 times. |
| Shackle Guard | ![](small-card-images/ShackleGuard.png) | ![](small-card-images/ShackleGuardPlus.png) | Common | Skill | 1 | Gain 10(15) Block. Exhaustive !stslib:ex!. |
| Sickness | ![](small-card-images/Sickness.png) | ![](small-card-images/SicknessPlus.png) | Common | Attack | 1 | Deal 5 damage. Apply 2(3) Disease. |
| Soul Spear | ![](small-card-images/SoulSpear.png) | ![](small-card-images/SoulSpearPlus.png) | Common | Attack | 1 | Deal 7(10) damage. Draw 1 card. |
| Unchained | ![](small-card-images/Unchained.png) | ![](small-card-images/UnchainedPlus.png) | Common | Attack | 1 | Deal 7(10) damage. Gain 1 Potency. |
| Vulgarity | ![](small-card-images/Vulgarity.png) | ![](small-card-images/VulgarityPlus.png) | Common | Skill | 0 | Gain 3(5) Block. Move a random Curse card from your draw pile to your hand. |
| Will-O-Wisp | ![](small-card-images/Will-O-Wisp.png) | ![](small-card-images/Will-O-WispPlus.png) | Common | Attack | 0 | Deal 5(8) damage. Apply 1 Vulnerable. |
| Afflicted Weapon | ![](small-card-images/AfflictedWeapon.png) | ![](small-card-images/AfflictedWeaponPlus.png) | Uncommon | Attack | 1 | Deal 10(13) damage. Apply 1 Disease. |
| Bacterial Culture | ![](small-card-images/BacterialCulture.png) | ![](small-card-images/BacterialCulturePlus.png) | Uncommon | Skill | 1 | If an enemy has Disease, remove it and apply 3(4) Scourge. If the enemy does not have Disease, apply 3(4) Disease. Exhaust. |
| Barbed Fist | ![](small-card-images/BarbedFist.png) | ![](small-card-images/BarbedFistPlus.png) | Uncommon | Attack | 1 | Deal 8(12) damage. Gain 3 Barbs. |
| Barbed Parry | ![](small-card-images/BarbedParry.png) | ![](small-card-images/BarbedParryPlus.png) | Uncommon | Skill | 1 | Gain 6 Block. If the enemy intends to attack, gain 5(13) Barbs. |
| Behead | ![](small-card-images/Behead.png) | ![](small-card-images/BeheadPlus.png) | Uncommon | Attack | 2 | Deal 14(17) damage. Apply 4 Vulnerable. |
| Beneath the Mask | ![](small-card-images/BeneaththeMask.png) | ![](small-card-images/BeneaththeMaskPlus.png) | Uncommon | Skill | 1 | Shuffle 3(4) Curse cards into your draw pile. Exhaust. |
| Blood Thinning | ![](small-card-images/BloodThinning.png) | ![](small-card-images/BloodThinningPlus.png) | Uncommon | Power | 2(1) | At the start of your turn, Exhaust 1 card. |
